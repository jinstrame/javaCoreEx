...
public class SaxParserTest {
    ...
    /**
     * 1) implement this operations in StudentHandler: startElement, endElement, characters
     * 2) implement parseSax() in SaxParser to use StudentHandler to parse xml file
     */
