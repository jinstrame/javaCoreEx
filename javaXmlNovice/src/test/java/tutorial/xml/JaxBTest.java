...
public class JaxBTest {
    ...
    /**
     * 1) implement marshalClass() and unmarshalClass() in JaxBImpl.class
     * 2) configure JAXBContext in ConfigurationClass.class
     * 3) add annotations in SimplePerson.class
     */
    @Test
